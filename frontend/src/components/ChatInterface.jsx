...
export default function ChatInterface({
  ...
  const handleSubmit = (e) => {
    ...
    if (input.trim() && !isLoading) {
      onSendMessage(input, webSearch, attachedFiles.length > 0 ? attachedFiles : null);
      setInput('');
      setAttachedFiles([]);
    }
  };
    ...
    return (
      <div className="chat-interface">
        <div className="empty-state">
          <h1>LLM Debate <span className="plus-text">Studio</span></h1>
        ...
        {(!conversation || conversation.messages.length === 0) ? (
          <div className="hero-container">
            <div className="hero-content">
              <h1>LLM Debate <span className="text-gradient">Studio</span></h1>
          ...
          conversation.messages.map((msg, index) => (
            <div key={`${conversation.id}-msg-${index}`} className={`message ${msg.role}`}>
              <div className="message-role">
                {msg.role === 'user' ? 'Your Question' : (
                  msg.mode === 'debate' ? 'Expert Debate' : 
                  msg.mode === 'chat' ? 'Expert Response' :
                  msg.stage1 ? 'LLM Council' : 'Response'
                )}
              </div>
              <div className="message-content">
                {msg.role === 'user' ? (
                  ...
                  <>
                    ...
                    {/* Legacy council mode for old conversations */}
                    {msg.stage1 && !msg.mode && (
                      <div className="markdown-content">
                        <ReactMarkdown>
          ...
          >
            ...
            <div className="input-row-top">
              ...
              <textarea
                ...
                placeholder={isLoading ? "Debating..." : "Ask the experts..."}
                value={input}
